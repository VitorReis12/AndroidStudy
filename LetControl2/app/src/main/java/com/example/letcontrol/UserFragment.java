...
public class UserFragment extends Fragment {
    ...
    public TextView MeuPerfil, TermosECondicoes, PoliticaDePrivacidade, Logout, RedeDoAparelho, tvName;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvName = view.findViewById(R.id.textViewNomeUserFragment);


        SharedPreferences prefs = requireActivity().getSharedPreferences("cadastro2", getContext().MODE_PRIVATE);
